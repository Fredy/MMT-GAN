...
from mmtgan.utils import ImageMerger, plot_example_images
...
MULTI_IMGS = 4
np.random.seed(123)
image_shape = (60, 95, 3 * MULTI_IMGS)
...
def train(
    ...
    img_merger = ImageMerger(plate_labels_path)
    ...
    for e in range(first_epoch, epochs + 1):
        ...
        for _ in tqdm(range(batch_count)):
            ...
            image_batch_train = img_merger.merge(
                rand_ints, MULTI_IMGS, train_imgs)
        ...
        if e == 1 or e % 5 == 0:
            plot_example_images(
                ...
                img_loader.imgs_count, img_merger, MULTI_IMGS)
        if e % 10 == 0:
